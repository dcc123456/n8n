...
export class LmOpenSiliconFlow implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'SiliconFlow Inference Model',

		name: 'lmOpenSiliconFlow',
		icon: 'file:siliconflow.svg',
		group: ['transform'],
		version: 1,
		description: 'Language Model SiliconFlow Inference',
		defaults: {
			name: 'SiliconFlow Inference Model',
		},
		codex: {
			categories: ['AI'],
			subcategories: {
